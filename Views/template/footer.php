            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="">Realizar Pedido</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>A una cuadra del paradero Establo, Frente a la iglesia - Puente Piedra</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+51 970145158</p>
                    </div>
                    <div class="col-lg-3 col-md-6">
