        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
             Selecciona un producto para realizar una orden
            </div>
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    <th scope="col"><b>Imagen referencial</b></th>
                    <th scope="col"><b>Codigo de producto</b></th>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>S/ <?php echo $prod->prod_price; ?></td>
                      <td>
