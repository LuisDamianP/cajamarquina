...
if (isset($_POST['reset_pwd'])) {
  ...
  if (mysqli_num_rows($checkEmail) > 0) {
    ...
    $reset->execute();
    if ($reset) {
      $success = "Instrucciones para restablecer la contraseña enviadas a su correo electrónico";
   
    } else {
      $err = "Vuelva a intentarlo o inténtelo más tarde";
    }
  } else {
    $err = "No hay cuenta con ese correo electrónico";
  }
}
          ...
          <div class="header-body text-center mb-7">
            <div class="row justify-content-center">
              <div class="col-lg-5 col-md-6">
                <h1 class="text-white">Restaurante "La Cajamarquina"</h1>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container mt--8 pb-5">
        <div class="row justify-content-center">
          <div class="col-lg-5 col-md-7">
              ...
              <div class="card-body px-lg-5 py-lg-5">
                <form method="post" role="form">
                  ...
                  <div class="text-center">
                    <button type="submit" name="reset_pwd" class="btn btn-primary my-4">Reiniciar Contraseña</button>
                  </div>
                </form>
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-6">
                <a href="index.php" class="text-light"><small>Ingresar?</small></a>
              </div>
            </div>
          </div>
        </div>
