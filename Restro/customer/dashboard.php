              ...
              <a href="orders_reports.php">
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Total de Ordenes realizadas:</h5>
              ...
              <a href="payments_reports.php">
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Total de pagos realizados:</h5>
                        <span class="h2 font-weight-bold mb-0">S/<?php echo $sales; ?></span>
                      </div>
                      <div class="col-auto">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="orders_reports.php" class="btn btn-sm btn-primary">Ver todas</a>
                </div>
              </div>
            </div>
