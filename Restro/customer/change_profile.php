    ...
    if (!$error) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($old_password != $row['customer_password']) {
                $err =  "Por favor ingrese la contraseña anterior correcta";
                ...
                if ($stmt) {
                    $success = "Contraseña cambiada" && header("refresh:1; url=dashboard.php");
                } else {
                    $err = "Inténtelo de nuevo o inténtelo más tarde";
                }
            }
                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            ...
                            Esta es tu página de perfil. Puedes personalizar tu perfil como quieras y también cambiar la contraseña</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <form method="post">
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            ...
                                            <div class=" col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-email">N° Celular:</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-email">Correo elecetrónico:</label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input type="submit" id="input-email" name="ChangeProfile" class="btn btn-success form-control-alternative" value="Guardar"">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form method =" post">
                                        ...
                                        <div class="pl-lg-4">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="input-username">Anterior contraseña</label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="submit" id="input-email" name="changePassword" class="btn btn-success form-control-alternative" value="Actualizar contraseña">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
